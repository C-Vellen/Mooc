...
AUTHLIB_OAUTH_CLIENTS = {
    "mooc": {
        "client_id": os.environ.get("OAUTH2_CLIENT_ID", "clientid"),
        "client_secret": os.environ.get("OAUTH2_CLIENT_SECRET", "xxxxxxx"),
        "server_metadata_url": os.environ.get(
            "OAUTH2_CONF_URL", "https://xxxx/.well-known/openid-configuration"
        ),
